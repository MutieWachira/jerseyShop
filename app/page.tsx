...
export default async function HomePage() {
  ...
  // Only admins get redirected — everyone else (logged in or not) sees the homepage
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="rounded-[1.5rem] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-8 text-white">
                ...
                <h2 className="mt-4 text-3xl font-extrabold tracking-tight">
                  2026 Elite Club Collection
                </h2>
                <p className="mt-4 text-sm leading-7 text-slate-200">
                  New season jerseys inspired by the world's most iconic clubs.
                  Sleek fit, stylish detail and premium feel
                </p>
                <div className="mt-8 rounded-3xl bg-white/10 p-6 backdrop-blur">
                  <div className="flex h-56 items-center justify-center rounded-3xl border border-white/10 bg-white/5 text-lg font-extrabold text-slate-200">
                    HERO PRODUCT IMAGE
                  </div>
                </div>
              </div>
