    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto max-w-6xl px-4 py-6 sm:py-20">
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            <p className="text-sm font-extrabold uppercase tracking-[0.2em] text-slate-500">Premium Footbal Jersey</p>
            <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:tex-6xl">
              Wear your club
              <span className="block text-slate-500">Own your style</span>
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">Discover authentic-looking football jerseys, fan favourites and limited-edition drops from the biggest clubs 
              in the world. Built for supporters who want style, comfort and identity
            </p>
            <div className="mt-18 flex flex-wrap items-center gap-4">
          ...
          <div className="relative">
            <div className="rounded-[2rem] boredr border-slate-200 bg-white p-6 shadow-sm">
              <div className="rounded-[1.5rem] bg-gradient-to-br from-slate-900 via-slate-800
              to-slate-700 p-8 text-white">
                <p className="text-sm font-bol uppercase tracking-[0.2em] text-slate-300">Featured Drop</p>
                <h2 className="mt-4 text-3xl font-extrabold tracking-tight">2026 Elite Club Collection</h2>
                <p className="mt-4 text-sm leading-7 text-slate-200"> New season jerseys
                  inspired by the world's most iconic clubs. Sleek fit, stylish detail and premium feel
                </p>
                <div className="mt-8 rounded-3xl bg-white/10 p-6 backdrop-blur">
                <div className="flex h-56 items-center justify-center rounded-3xl border border-white/10 bg-white/5 text-lg font-extrabold text-slate-200">HERO PRODUCT IMAGE
                </div>
                </div>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-extabold tracking-tight text-slate-900">Fan favourite this week</h2>
          </div>
        ...
        {featuredProducts.length === 0 && (
          <div className="col-span-full ronded-2xl border border-slate-200 g-white p-6 text-center text-sm text-slate-600 shadow-sm">No featured products yet</div>
        )}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-20">
        <div className="rounded-[2rem] border border-slate-200 bg-slate-900 px-6 py-10 text-white shadow-sm sm:px-10">
          <div className="max-w-2xl">
            ...
            <p className="mt4 text-sm leading-7 text-slate-300 sm:text-base">Explore club collections,
              compare styles and build a modern football wardrobe from one clean shopping experience
            </p>
            <div className="mt-6">
              <Link href="/shop" className="inline-flex rounded-2xl bg-white px-6 py-3 text-sm
              font-extrabold text-slate-900 transiiton hover:bg-slate-100">Explore Shop</Link>
            </div>   
          </div>
        </div>
      </section>
