      ...
      <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="text-slate-900 mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-slate-900"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="text-slate-900 mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-slate-900"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-3.5 text-slate-500 hover:text-slate-900"
              >
                {showPassword ? (
